...
const faqData = [
  {
    question: "What is TrustVest?",
    answer: "TrustVest is a decentralized crypto fund platform that allows users to invest in various cryptocurrency strategies with transparency and security. Our operations are managed by smart contracts on the blockchain.",
  },
  {
  ...
  {
    question: "How do I get started with TrustVest?",
    ...
    <div className="space-y-16">
      <header className="text-center">
        ...
        <p className="text-lg text-muted-foreground mt-2 max-w-2xl mx-auto">
          Understand DeFi, blockchain, and how TrustVest is pioneering transparent investments.
        </p>
      </header>
      ...
      <section className="text-center py-8">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="p-6 border border-dashed border-border rounded-lg text-left">
                ...
                <p className="text-sm text-muted-foreground">An upcoming guide on how smart contracts power TrustVest and ensure trustless operations.</p>
            </div>
            <div className="p-6 border border-dashed border-border rounded-lg text-left">
